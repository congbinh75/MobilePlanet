...
<html>
    <head>
        <title>Phụ kiện - Mobile Planet</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="wrapper">
            ...
            <main class="content dynamic-container">
                <h3 style="width: fit-content; margin: 0 auto 1rem auto;">Phụ kiện</h3>
                    ...
                    <form method="get">
                        <div style="width: 100%; margin: 1rem;" class="row">
                            ...
                            <div class="col-lg-2 col-6">
                                ...
                                <input type="checkbox" name="brand[]" value="AVA"  style="margin: 0.5rem;"><label>AVA</label><br/>
                            </div>
                        </div>
...
<?php
                if(isset($_GET['submit'])){
                    ...
                    $controller->accessories_category_invoke("filter");
                }
                else{
                    require_once($_SERVER['DOCUMENT_ROOT']."/controllers/filter_controller.php");
                    $controller = new FilterController();
                    $controller->accessories_category_invoke("all");
                }
