...
<html>
    <head>
        <title>Điện thoại - Mobile Planet</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="wrapper">
            ...
            <main class="content dynamic-container">
                <h3 style="width: fit-content; margin: 0 auto 1rem auto;">Điện thoại di động</h3>
                    ...
                    <form method="get">
                        <div style="width: 100%; margin: 1rem;" class="row">
                            ...
                            <div class="col-lg-2 col-6">
                                ...
                                <input type="checkbox" name="ram[]" value="12" style="margin: 0.5rem;"><label>12GB</label><br/>
                            </div>
                            <div class="col-lg-2 col-6">
                                ...
                                <input type="checkbox" name="brand[]" value="Xiaomi"  style="margin: 0.5rem;"><label>Xiaomi</label><br/>
                                <input type="checkbox" name="brand[]" value="Vivo"  style="margin: 0.5rem;"><label>Vivo</label><br/>
                                <input type="checkbox" name="brand[]" value="OPPO" style="margin: 0.5rem;"><label>OPPO</label><br/>
                                <input type="checkbox" name="brand[]" value="Realme"  style="margin: 0.5rem;"><label>Realme</label><br/>
                                <input type="checkbox" name="brand[]" value="Vsmart" style="margin: 0.5rem;"><label>Vsmart</label><br/>
                            </div>
                            <div class="col-lg-2 col-6">
                                ...
                                <input type="checkbox" name="bnt[]" value="256" style="margin: 0.5rem;"><label>256GB</label><br/>
                            </div>
                        </div>
...
<?php
                if(isset($_GET['submit'])){
                    ...
                    $controller->phone_category_invoke("filter");
                }
                else{
                    require_once($_SERVER['DOCUMENT_ROOT']."/controllers/filter_controller.php");
                    $controller = new FilterController();
                    $controller->phone_category_invoke("all");
                }
