...
<html>
    <head>
        <title>Máy tính xách tay - Mobile Planet</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="wrapper">
            ...
            <main class="content dynamic-container">
                <h3 style="width: fit-content; margin: 0 auto 1rem auto;">Máy tính xách tay</h3>
                    ...
                    <form method="get">
                        <div style="width: 100%; margin: 1rem;" class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <input type="checkbox" name="price[]" value="<15"    style="margin: 0.5rem;"><label>Dưới 15 triệu</label><br/>
                                <input type="checkbox" name="price[]" value="15-20" style="margin: 0.5rem;"><label>Từ 15 đến 20 triệu</label><br/>
                                <input type="checkbox" name="price[]" value="20-30" style="margin: 0.5rem;"><label>Từ 20 đến 30 triệu</label><br/>
                                <input type="checkbox" name="price[]" value=">30"    style="margin: 0.5rem;"><label>Trên 30 triệu</label><br/>
                            </div>
                            <div class="col-lg-2 col-6">
                                ...
                                <input type="checkbox" name="brand[]" value="Acer"  style="margin: 0.5rem;"><label>Acer</label><br/>
                                <input type="checkbox" name="brand[]" value="Dell"  style="margin: 0.5rem;"><label>Dell</label><br/>
                                <input type="checkbox" name="brand[]" value="Lenovo" style="margin: 0.5rem;"><label>Lenovo</label><br/>
                                <input type="checkbox" name="brand[]" value="Hp" style="margin: 0.5rem;"><label>Hp</label><br/>
                            </div>
                            <div class="col-lg-2 col-6">
                                <label style="font-weight: 500;">CPU</label><br/>
                                <input type="checkbox" name="CPU[]" value="apple" style="margin: 0.5rem;"><label>Apple</label><br/>
                                <input type="checkbox" name="CPU[]" value="5" style="margin: 0.5rem;"><label>Intel Core i5</label><br/>
                                <input type="checkbox" name="CPU[]" value="7" style="margin: 0.5rem;"><label>Intel Core i7</label><br/>
                                <input type="checkbox" name="CPU[]" value="AMD" style="margin: 0.5rem;"><label>AMD</label><br/>
                            </div>
                            <div class="col-lg-2 col-6">
                                ...
                                <input type="checkbox" name="ram[]" value="16" style="margin: 0.5rem;"><label>16GB</label><br/>
                            </div>
                        </div>
                        <button type="submit" name="submit" class="btn btn-primary" style="margin: 1rem;">Áp dụng</button>
                    </form>
...
<?php
                if(isset($_GET['submit'])){
                    ...
                    $controller->laptop_category_invoke("filter");
                }
                else{
                    require_once($_SERVER['DOCUMENT_ROOT']."/controllers/filter_controller.php");
                    $controller = new FilterController();
                    $controller->laptop_category_invoke("all");
                }
